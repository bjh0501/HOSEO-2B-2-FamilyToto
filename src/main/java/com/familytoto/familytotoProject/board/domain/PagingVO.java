...
public class PagingVO {
	...
	public String toString() {
		return "PagingVO [listSize=" + listSize + ", rangeSize=" + rangeSize + ", page=" + page + ", range=" + range
				...
				+ startList + ", endPage=" + endPage + ", prev=" + prev + ", next=" + next + ", getRangeSize()="
				+ getRangeSize() + ", getPage()=" + getPage() + ", getRange()=" + getRange() + ", getStartPage()="
				+ getStartPage() + ", getEndPage()=" + getEndPage() + ", isPrev()=" + isPrev() + ", isNext()="
				+ isNext() + ", getListSize()=" + getListSize() + ", getListCnt()=" + getListCnt() + ", getStartList()="
				+ getStartList() + ", getClass()=" + getClass() + ", hashCode()=" + hashCode() + ", toString()="
				+ super.toString() + "]";
	}
