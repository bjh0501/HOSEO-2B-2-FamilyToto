...
//			// [START initialize]
//			FileInputStream serviceAccount = new FileInputStream("onesports-8620b-firebase-adminsdk-emr1a-845f23f413.json");
//			FirebaseOptions options = new FirebaseOptions.Builder()
...
//		database.child("users").child("A").child("username").setValueAsync("B");
//	}
//	
//	public class User {
//
